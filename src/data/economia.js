...
export const PROPRIEDADES_VENDA = [
  ...
  },
  {
    ...
    tipo: "nua",
    preco: 32000,
    desc: "Baixada plana de 5ha — espaço pra crescer e mecanizar. Planta do zero.",
  },
  {
    id: "alto_da_serra",
    nome: "Alto da Serra",
    ...
    tipo: "nua",
    preco: 26000,
    desc: "6ha de morro alto — altitude dá bebida fina, mas exige manejo de montanha.",
  },
  {
    id: "varzea_grande",
    nome: "Várzea Grande",
    ...
    tipo: "nua",
    preco: 55000,
    desc: "Grande área plana (9ha) — ideal pra colhedora e super-adensado. Planta do zero.",
  },
  {
    id: "fazenda_bourbon",
    nome: "Fazenda Bourbon",
    hectares: 4,
    terreno: "montanhoso",
    tipo: "pronta",
    variedade: "bourbon_amarelo",
    preco: 78000,
    desc: "Lavoura de Bourbon Amarelo formada em altitude — café especial pronto pra brilhar.",
  },
  {
    id: "planalto_cerrado",
    nome: "Planalto do Cerrado",
    hectares: 12,
    terreno: "plano",
    tipo: "pronta",
    variedade: "mundo_novo",
    preco: 145000,
    desc: "Latifúndio plano de 12ha já produzindo — volume de exportação. Caro, mas rende em escala.",
  },
];
